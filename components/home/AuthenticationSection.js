  ...
  return (
    <div className={styles.container}>
      <div className={styles.leftSide}>
        ...
        {hasWindow && <ReactPlayer url='https://www.youtube.com/watch?v=rHEtopZuhsE' light="/images/portal.jpg" width="700px" height="500px" playIcon={<span className={styles.iconColor}><BsFillPlayCircleFill size={80}/></span>}/>}
      </div>
